...
export default async function HomePage({
  ...
  return (
    <div className="min-h-screen bg-stone-100">
      ...
      <section className="bg-stone-900 text-stone-50 py-10">
        ...
        {!listings || listings.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {listings.map((listing) => {
              ...
              return (
                <Link key={listing.id} href={'/ilan/' + listing.id} className="group bg-stone-50 border-2 border-stone-900 hover:border-red-700 transition hover:-translate-y-1 block">
      ...
      <footer className="bg-stone-900 text-stone-300 mt-16 py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="font-mono text-xs">
            (c) 2026 DEGALINA - Turkiye nin Diecast Pazari
          </p>
        </div>
      </footer>
    </div>
